...
leaflet(occ_sf) |>
  ...
  # Buffer 2 (orange) — replace with your second buffer object, add more for others
  addPolygons(data = buffer_50km, fillColor = "#FFA500", color = "#FF8C00",
              weight = 1, fillOpacity = 0.1, popup = "Another buffer")
```
...
```{r}
# YOUR CODE HERE: assign your favourite buffer:
...
# install remotes first if you don't have it: install.packages("remotes")
